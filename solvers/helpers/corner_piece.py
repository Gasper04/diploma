...
class CornerPiece:
    def __init__(self, color1: Color, color2: Color, color3: Color, face1: Face = None, face2: Face = None, face3: Face = None, i: int = 1):
        self.color1 = color1
        self.color2 = color2
        self.color3 = color3
        self.face1 = face1
        ...
        for loc in possible_locations:
            if cube.get(face, loc[0], loc[1]) == corner_piece.color1.value:
                ...
                if set([cube.get(f.face, f.i, f.j) for f in touching_facelets]) == set([corner_piece.color2.value, corner_piece.color3.value]):
                    ...
                    return CornerPiece(color1=corner_piece.color1, color2=corner_piece.color2, color3=corner_piece.color3, face1=face, face2=touching_facelets[1].face, face3=touching_facelets[2].face )
